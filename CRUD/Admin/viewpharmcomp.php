...
if (isset($_GET['search'])) {
    $searchTerm = urldecode(trim($_GET['search']));

    // URL decode the search term if needed
    $searchTerm = urldecode($searchTerm);

    // Modify your query to include the search term
    $sql = "SELECT * FROM pharmaceuticals WHERE name LIKE '%$searchTerm%'";
...
<a href="../../home.php">home</a>
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                <a href="../../users/admin.php" class="list-group-item list-group-item-action bg-transparent second-text active"><i
                        ...
                        <a href="viewpatients.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i
        ...
        <div id="page-content-wrapper">
            ...
            <h2 class="fs-1 m-2">Pharmaceutical Companies</h2>


            <form method="GET" action="viewpharmcomp.php">
        <div class="input-group">
        <input type="text" name="search" class="form-control form-control-sm" style="width: 50px; font-weight: bold; font-size: 16px;" placeholder="Search by company name" />
  ...
  <?php
  $sql="SELECT * from pharmaceuticals";
  $result=mysqli_query($conn,$sql);
