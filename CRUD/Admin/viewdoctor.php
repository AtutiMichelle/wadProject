...
<a href="../../home.php">home</a>
  ...
  if($result){ 
    ...
    $row=mysqli_fetch_assoc($result)){
        ...
        <button class="btn btn-outline-danger"><a href="delete.php?deletedoctor_id='.$doctor_id.'" class="text-dark">Delete</a></button>
    </td>
      </tr>';
